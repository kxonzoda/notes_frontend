...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            if (this.form.email === '') {
                this.errors.push('Iltmos emailni kiriting');
            }
            if (this.form.username.length <= 3) {
                this.errors.push("Parol 3 belgidan koproq bo`lishi kerak");
            }
            if (this.form.password === '') {
                this.errors.push("Iltimos parolni kiriting");
            }
            if (this.form.password.length <= 8) {
                this.errors.push("Parol 8 belgidan koproq bo`lishi kerak");
            }
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form v-on:submit.prevent="submitForm" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div>
                            ...
                            <input v-model="form.password2" type="confirm-password" name="confirm-password" id="confirm-password"
                                placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    <button type="submit"
